...
function wp_bootstrap_custom_admin_footer() {
	echo '<span id="footer-thankyou">Developed by <a href="http://brodyberson.com" target="_blank">Brody Berson</a></span>. Built using <a href="http://themble.com/bones" target="_blank">Bones</a>.';
}
...
if( !function_exists( "theme_js" ) ) {  
  function theme_js(){
    ...
    wp_register_script(  'retina', 
      get_template_directory_uri() . '/library/js/retina.js', 
      array('jquery'), 
      '1.2' );
